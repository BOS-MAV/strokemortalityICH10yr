...
function calc_risk() {
  ...
  if (bpSys < 120) bpSysWeight = 0.14765;
  else if (bpSys <= 129) bpSysWeight = 0.17194;
  else if (bpSys <= 139) bpSysWeight = 0;
  else bpSysWeight = 0.1596;
  ...
  if (BMI < 18.5) BMIWeight = 0.65892;
  else if (BMI <= 24.9) BMIWeight = 0.26783;
  else if (BMI <= 29.9) BMIWeight = 0;
  else if (BMI <= 34.9) BMIWeight = -0.13744;
  else if (BMI <= 39.9) BMIWeight = -0.01768;
  else BMIWeight = -0.08244;
  // creatine
  if (
    $("#creat").val() === "" ||
    $("#creat").val() === "M" ||
  ...
  if (creatinine < 0.74) creatWeight = 0.04083;
  else if (creatinine <= 1.35) creatWeight = 0;
  else creatWeight = 0.22305;
  //TBI
  if ($("input[name = 'TBIR']:checked").val() === "No") TBIWeight = 0;
  else TBIWeight = 0.39449;
